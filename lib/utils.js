...
function mergeAllXPData(projectData, indieData, cabsData, bountyData) {
...
function getLeaderboardData(projectData, indieData, cabsData, bountyData) {

  const mergedData = mergeAllXPData(projectData, indieData, cabsData, bountyData);
