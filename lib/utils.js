...
function mergeAllXPData(projectData, indieData, cabsData) {
...
function getLeaderboardData(projectData, indieData, cabsData) {

  const mergedData = mergeAllXPData(projectData, indieData, cabsData);
